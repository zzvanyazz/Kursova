...
public:
    ...
    void setupUi(QWidget *GroupInputForm)
    {
        if (GroupInputForm->objectName().isEmpty())
            GroupInputForm->setObjectName(QString::fromUtf8("GroupInputForm"));
        GroupInputForm->resize(400, 300);
        GroupInputForm->setStyleSheet(QString::fromUtf8("background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0.034, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(5, 61, 8, 255));"));
        ...
        spinBoxCounter->setObjectName(QString::fromUtf8("spinBoxCounter"));
        ...
        boxDepartments->setObjectName(QString::fromUtf8("boxDepartments"));
        ...
        boxCurator->setObjectName(QString::fromUtf8("boxCurator"));
