...
public:
    ...
    void setupUi(QWidget *StudenrInputForm)
    {
        if (StudenrInputForm->objectName().isEmpty())
            StudenrInputForm->setObjectName(QString::fromUtf8("StudenrInputForm"));
        StudenrInputForm->resize(440, 383);
        StudenrInputForm->setStyleSheet(QString::fromUtf8("background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0.034, stop:0.365385 rgba(0, 0, 0, 255), stop:1 rgba(53, 35, 5, 255));"));
        ...
        studentLastName->setObjectName(QString::fromUtf8("studentLastName"));
        ...
        studyTypeCheck->setObjectName(QString::fromUtf8("studyTypeCheck"));
